...
SetSpectatorRates(client)
{
    SendConVarValue(client, sv_mincmdrate, "8");
    SendConVarValue(client, sv_maxcmdrate, "8");
    SendConVarValue(client, sv_minupdaterate, "8");
    SendConVarValue(client, sv_maxupdaterate, "8");
    SendConVarValue(client, sv_minrate, "100");
    SendConVarValue(client, sv_maxrate, "100");

    SetClientInfo(client, "cl_updaterate", "8");
    SetClientInfo(client, "cl_cmdrate", "8");
}
