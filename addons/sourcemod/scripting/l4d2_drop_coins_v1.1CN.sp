...
public OnPluginStart(){
	...
	Coin_Drop_Num			= CreateConVar("L4D2_Coin_Drop_Num", 			"20", 			"死亡后掉落多少金币",							FCVAR_NOTIFY, true, 0.0, true, 999.0);
	...
	Coin_Glow_Range			= CreateConVar("L4D2_Coin_Glow_Range", 			"1000", 		"金币发光范围",									FCVAR_NOTIFY, true, 0.0, true, 9999.0);
